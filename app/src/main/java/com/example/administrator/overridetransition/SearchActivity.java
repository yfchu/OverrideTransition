...
public class SearchActivity extends AppCompatActivity {
    ...
    private void performEnterAnimation() {
        Intent intent=new Intent("yfchu");
        ...
        final ValueAnimator translateVa = ValueAnimator.ofFloat(mSearchBGTxt.getY(), mSearchBGTxt.getY() / 4);
        searchBgHeight = mSearchBGTxt.getY();
        translateVa.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                Log.i("yfchu",valueAnimator.getAnimatedValue()+"");
                ...
                linearParams.height = (int) (frameBgHeight-(searchBgHeight-(Float) valueAnimator.getAnimatedValue())*1.8);
